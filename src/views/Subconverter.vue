...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "xxllllll.vercel.app (自动编译最新版本后端-测试）": "https://xxllllll.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://xxllllll.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://xxllllll.vercel.app/sub?";
